...
export function buildDemoData() {
  ...
  const template1 = {
    ...
    sets: [
      ...
      { kind: 'set' as const, id: id(), description: '4x50 Beine', distance: 50, durationSec: null, reps: 4, intensity: 'locker', restSec: 15, exerciseId: kickboardEx.id, comments: [] },
      { kind: 'set' as const, id: id(), description: 'Ausschwimmen', distance: 200, durationSec: null, reps: 1, intensity: 'locker', restSec: 0, comments: [] },
    ],
  };
  const template2 = {
    ...
    sets: [
      { kind: 'set' as const, id: id(), description: 'Einschwimmen', distance: 300, durationSec: null, reps: 1, intensity: 'locker', restSec: 0, comments: [] },
      {
        ...
        sets: [
          { kind: 'set' as const, id: id(), description: '2x25 Sprint ab Wende', distance: 25, durationSec: null, reps: 2, intensity: 'sprint', restSec: 30, exerciseId: sprintEx.id, comments: [] },
          { kind: 'set' as const, id: id(), description: '50 locker ausschwimmen', distance: 50, durationSec: null, reps: 1, intensity: 'locker', restSec: 20, comments: [] },
        ],
      },
      { kind: 'set' as const, id: id(), description: '4x50 Renntempo', distance: 50, durationSec: null, reps: 4, intensity: 'renotempo', restSec: 40, comments: [] },
      { kind: 'set' as const, id: id(), description: 'Ausschwimmen locker', distance: 150, durationSec: null, reps: 1, intensity: 'locker', restSec: 0, comments: [] },
    ],
  };
