...
|---|---|---|
| **Phase 1** | 3 | 3.1 Wiederkehrende Trainingspläne/Vorlagen-Zyklen (offen), 3.2 Belastungssteuerung/Trainingsumfang-Auswertung (offen), 3.3 Anwesenheitsstatistik & -prognose (**umgesetzt**) — detaillierter Umsetzungsplan inkl. Umsetzungsstand: `docs/trainingsplanung-phase1-plan.md` |
