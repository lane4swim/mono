...
|---|---|---|
| **Phase 1** | 3 | 3.1 Wiederkehrende Trainingspläne/Vorlagen-Zyklen, 3.2 Belastungssteuerung/Trainingsumfang-Auswertung, 3.3 Anwesenheitsstatistik & -prognose — detaillierter Umsetzungsplan: `docs/trainingsplanung-phase1-plan.md` |
